...
import { _ as _sfc_main$5 } from "./Checkbox-703fcead.js";
import { _ as _sfc_main$1 } from "./GuestLayout-7a1e2727.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Вход в админ. панель" }, null, _parent2, _scopeId));
            if (__props.status) {
            ...
            return [
              createVNode(unref(Head), { title: "Вход в админ. панель" }),
