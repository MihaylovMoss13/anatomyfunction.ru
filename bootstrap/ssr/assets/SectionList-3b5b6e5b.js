    ...
    return (_ctx, _push, _parent, _attrs) => {
                            ...
                            if (tab.text == "text_leg_bedr_treug") {
                                ...
                                tip: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    ...
                                    if (model3DLegBedrTreug.value !== null) {
                                      _push5(`<p class="el-upload__tip"${_scopeId4}> Загружен файл - ${ssrInterpolate(model3DLegBedrTreug.value)}</p>`);
                                    } else {
                                    ...
                                    return [
                                      ...
                                      }, " Загружен файл - " + toDisplayString(model3DLegBedrTreug.value), 1)) : (openBlock(), createBlock("p", { key: 1 }, "Файл не загружен"))
                                    ];
                                  }
                                }),
                              ...
                              _push4(ssrRenderComponent(_component_el_upload, {
                                ...
                                tip: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(`<div class="el-upload__tip"${_scopeId4}> только модели формата.glb </div>`);
                                    if (model3DLegBedrTreug.value.length > 0) {
                                      _push5(`<p class="el-upload__tip"${_scopeId4}> Загружен файл - ${ssrInterpolate(model3DLegPodkolYamk.value)}</p>`);
                                    } else {
                                      _push5(`<p${_scopeId4}>Файл не загружен</p>`);
                                    }
                                  } else {
                                    return [
                                      createVNode("div", { class: "el-upload__tip" }, " только модели формата.glb "),
                                      model3DLegBedrTreug.value.length > 0 ? (openBlock(), createBlock("p", {
                                        key: 0,
                                        class: "el-upload__tip"
                                      }, " Загружен файл - " + toDisplayString(model3DLegPodkolYamk.value), 1)) : (openBlock(), createBlock("p", { key: 1 }, "Файл не загружен"))
                                    ];
                                  }
                                }),
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              ...
                              _push4(ssrRenderComponent(_component_el_upload, {
                                ...
                                tip: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(`<div class="el-upload__tip"${_scopeId4}> только модели формата.glb </div>`);
                                    if (model3DLegBedrTreug.value.length > 0) {
                                      _push5(`<p class="el-upload__tip"${_scopeId4}> Загружен файл - ${ssrInterpolate(model3DLegGoleni.value)}</p>`);
                                    } else {
                                      _push5(`<p${_scopeId4}>Файл не загружен</p>`);
                                    }
                                  } else {
                                    return [
                                      ...
                                      model3DLegBedrTreug.value.length > 0 ? (openBlock(), createBlock("p", {
                                        key: 0,
                                        class: "el-upload__tip"
                                      }, " Загружен файл - " + toDisplayString(model3DLegGoleni.value), 1)) : (openBlock(), createBlock("p", { key: 1 }, "Файл не загружен"))
                                    ];
                                  }
                                }),
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
      ...
      ssrRenderList(unref(sections).data, (section, index) => {
        ...
        if (section.name === "Нога") {
          _push(`<ul><p class="flex gap-1">1. <span>${ssrInterpolate(section.model_3D_leg_bedr_treug)}</span></p><p class="flex gap-1">2. <span>${ssrInterpolate(section.model_3D_leg_podkol_yamk)}</span></p><p class="flex gap-1">3. <span>${ssrInterpolate(section.model_3D_leg_goleni)}</span></p></ul>`);
        } else {
          _push(`<!---->`);
        }
