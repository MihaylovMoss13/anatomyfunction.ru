...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)}><header><div class="flex justify-between"><h2 class="text-lg font-medium text-gray-900">Profile Information</h2>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home"),
        class: "inline-flex bg-black hover:bg-gray-700 text-white px-2 py-1 rounded-lg shadow"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_icon, { class: "mt-1 mr-1" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Back), null, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(unref(Back))
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode(_component_el_icon, { class: "mt-1 mr-1" }, {
                default: withCtx(() => [
                  createVNode(unref(Back))
                ]),
                _: 1
      ...
      _push(`</div><p class="mt-1 text-sm text-gray-600"> Update your account&#39;s profile information and email address. </p></header><form class="mt-6 space-y-6"><div>`);
