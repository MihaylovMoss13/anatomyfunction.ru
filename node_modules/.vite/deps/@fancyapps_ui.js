...
Object.defineProperty(p, "version", { enumerable: true, configurable: true, writable: true, value: "5.0.28" }), Object.defineProperty(p, "defaults", { enumerable: true, configurable: true, writable: true, value: {} });
...
var R = class _R extends g {
  ...
  attachEvents() {
    ...
    t2.addEventListener("click", this.onClick, { passive: false, capture: false }), t2.addEventListener("wheel", this.onWheel, { passive: false }), this.pointerTracker = new l(t2, { start: this.onPointerDown, move: this.onPointerMove, end: this.onPointerUp }), document.addEventListener(M, this.onMouseMove);
  }
  detachEvents() {
    var t2;
    const { container: e2 } = this;
    e2.removeEventListener("click", this.onClick, { passive: false, capture: false }), e2.removeEventListener("wheel", this.onWheel, { passive: false }), null === (t2 = this.pointerTracker) || void 0 === t2 || t2.stop(), this.pointerTracker = null, document.removeEventListener(M, this.onMouseMove), document.removeEventListener("keydown", this.onKeydown, true), this.clickTimer && (clearTimeout(this.clickTimer), this.clickTimer = null), this.updateTimer && (clearTimeout(this.updateTimer), this.updateTimer = null);
  }
  animate() {
    this.setTargetForce();
  ...
  checkBounds(t2 = 0, e2 = 0) {
    ...
    let u2 = 0, f2 = 0;
    return l2 !== 1 / 0 && n2 < l2 ? u2 = l2 - n2 : c2 !== 1 / 0 && n2 > c2 && (u2 = c2 - n2), h2 !== 1 / 0 && s2 < h2 ? f2 = h2 - s2 : d2 !== 1 / 0 && s2 > d2 && (f2 = d2 - s2), Math.abs(u2) < 1e-4 && (u2 = 0), Math.abs(f2) < 1e-4 && (f2 = 0), Object.assign(Object.assign({}, o2), { xDiff: u2, yDiff: f2, inBounds: !u2 && !f2 });
  }
  clampTargetBounds() {
  ...
  calculateContentDim(t2 = this.current) {
    ...
    if (this.option("zoom") || 0 !== this.angle) {
      const i3 = !(e2 instanceof HTMLImageElement) && ("none" === window.getComputedStyle(e2).maxWidth || "none" === window.getComputedStyle(e2).maxHeight), c2 = i3 ? o2 : n2, h2 = i3 ? a2 : s2, d2 = this.getMatrix(t2), u2 = new DOMPoint(0, 0).matrixTransform(d2), f2 = new DOMPoint(0 + c2, 0).matrixTransform(d2), p2 = new DOMPoint(0 + c2, 0 + h2).matrixTransform(d2), g2 = new DOMPoint(0, 0 + h2).matrixTransform(d2), m2 = Math.abs(p2.x - u2.x), b2 = Math.abs(p2.y - u2.y), v2 = Math.abs(g2.x - f2.x), y2 = Math.abs(g2.y - f2.y);
  ...
  onPointerMove(e2, n2, s2) {
    ...
    const u2 = c(s2[0], s2[1]), f2 = c(n2[0], n2[1]);
    let p2 = u2 ? f2 / u2 : 1, g2 = r2.clientX - a2.clientX, m2 = r2.clientY - a2.clientY;
    ...
    const v2 = this.checkBounds(g2, m2);
    this.option("rubberband") ? ("x" !== this.isInfinite && (v2.xDiff > 0 && g2 < 0 || v2.xDiff < 0 && g2 > 0) && (g2 *= Math.max(0, 0.5 - Math.abs(0.75 / this.contentRect.fitWidth * v2.xDiff))), "y" !== this.isInfinite && (v2.yDiff > 0 && m2 < 0 || v2.yDiff < 0 && m2 > 0) && (m2 *= Math.max(0, 0.5 - Math.abs(0.75 / this.contentRect.fitHeight * v2.yDiff)))) : (v2.xDiff && (g2 = 0), v2.yDiff && (m2 = 0));
    const y2 = this.targetScale, w2 = this.minScale, x2 = this.maxScale;
    y2 < 0.5 * w2 && (p2 = Math.max(p2, w2)), y2 > 1.5 * x2 && (p2 = Math.min(p2, x2)), "y" === this.lockedAxis && t(y2) === t(w2) && (g2 = 0), "x" === this.lockedAxis && t(y2) === t(w2) && (m2 = 0), this.applyChange({ originX: l2, originY: d2, panX: g2, panY: m2, scale: p2, friction: this.option("dragFriction"), ignoreBounds: true });
  }
  ...
  startDecelAnim() {
    ...
    1 !== c2 && (a2 *= c2, r2 *= c2);
    let h2 = 0, d2 = 0, u2 = 0, f2 = 0, p2 = this.option("decelFriction");
    const g2 = this.targetScale;
    if (l2 > 0) {
      u2 = Math.abs(a2) > 3 ? a2 / (l2 / 30) : 0, f2 = Math.abs(r2) > 3 ? r2 / (l2 / 30) : 0;
      const t2 = this.option("maxVelocity");
      t2 && (u2 = Math.max(Math.min(u2, t2), -1 * t2), f2 = Math.max(Math.min(f2, t2), -1 * t2));
    }
    u2 && (h2 = u2 / (1 / (1 - p2) - 1)), f2 && (d2 = f2 / (1 / (1 - p2) - 1)), ("y" === this.option("lockAxis") || "xy" === this.option("lockAxis") && "y" === this.lockedAxis && t(g2) === this.minScale) && (h2 = u2 = 0), ("x" === this.option("lockAxis") || "xy" === this.option("lockAxis") && "x" === this.lockedAxis && t(g2) === this.minScale) && (d2 = f2 = 0);
    const m2 = this.dragOffset.x, v2 = this.dragOffset.y, y2 = this.option("dragMinThreshold") || 0;
    Math.abs(m2) < y2 && Math.abs(v2) < y2 && (h2 = d2 = 0, u2 = f2 = 0), (this.option("zoom") && (g2 < this.minScale - 1e-5 || g2 > this.maxScale + 1e-5) || i2 && !h2 && !d2) && (p2 = 0.35), this.applyChange({ panX: h2, panY: d2, friction: p2 }), this.emit("decel", u2, f2, m2, v2);
  }
  onWheel(t2) {
    ...
    if (this.emit("wheel", t2, i2), this.panMode === M)
      return;
  ...
  setTransform() {
    ...
    for (const n3 of b) {
      const s3 = "e" == n3 || "f" === n3 ? T : C;
      o2[n3] = t(e2[n3], s3), Math.abs(i2[n3] - e2[n3]) < ("e" == n3 || "f" === n3 ? 0.51 : 1e-3) && (e2[n3] = i2[n3]);
    }
    let { a: a2, b: r2, c: l2, d: c2, e: h2, f: d2 } = o2, u2 = `matrix(${a2}, ${r2}, ${l2}, ${c2}, ${h2}, ${d2})`, f2 = n2.parentElement instanceof HTMLPictureElement ? n2.parentElement : n2;
    if (this.option("transformParent") && (f2 = f2.parentElement || f2), f2.style.transform === u2)
      return;
    f2.style.transform = u2;
    const { contentWidth: p2, contentHeight: g2 } = this.calculateContentDim();
    s2.width = p2, s2.height = g2, this.emit("afterTransform");
  }
  updateMetrics(e2 = false) {
    ...
    const d2 = parseFloat(l2.paddingTop) + parseFloat(l2.paddingBottom), u2 = c2 - (parseFloat(l2.paddingLeft) + parseFloat(l2.paddingRight)), f2 = h2 - d2;
    this.containerRect = { width: c2, height: h2, innerWidth: u2, innerHeight: f2 };
    let p2 = this.option("width") || "auto", g2 = this.option("height") || "auto";
    ...
    a2 && (Math.abs(p2 - w2) > 1 || Math.abs(g2 - x2) > 1) && ({ width: w2, height: x2, top: E2, left: S2 } = ((t2, e3, i3, n3) => {
      const s3 = i3 / n3;
      return s3 > t2 / e3 ? (i3 = t2, n3 = t2 / s3) : (i3 = e3 * s3, n3 = e3), { width: i3, height: n3, top: 0.5 * (e3 - n3), left: 0.5 * (t2 - i3) };
    })(w2, x2, p2, g2)), this.contentRect = Object.assign(Object.assign({}, this.contentRect), { top: y2.top - r2.top + E2, bottom: r2.bottom - y2.bottom + E2, left: y2.left - r2.left + S2, right: r2.right - y2.right + S2, fitWidth: w2, fitHeight: x2, width: w2, height: x2, fullWidth: p2, fullHeight: g2 }), b2.style.cssText = v2, a2 && (b2.style.width = `${w2}px`, b2.style.height = `${x2}px`), this.setTransform(), true !== e2 && this.emit("refresh"), this.ignoreBounds || (t(this.targetScale) < t(this.minScale) ? this.zoomTo(this.minScale, { friction: 0 }) : this.targetScale > this.maxScale ? this.zoomTo(this.maxScale, { friction: 0 }) : this.state === m.Init || this.checkBounds().inBounds || this.requestTick()), this.updateControls();
  }
  calculateBounds() {
    ...
    if (true === d2 || s2 && d2 === s2)
      ...
      let { containerRect: s3, contentRect: d3 } = this, u2 = t(o2 * n2, T), f2 = t(a2 * n2, T), { innerWidth: p2, innerHeight: g2 } = s3;
      if (s3.width === u2 && (p2 = s3.width), s3.width === f2 && (g2 = s3.height), e2 > p2) {
        c2 = 0.5 * (e2 - p2), r2 = -1 * c2;
        let t2 = 0.5 * (d3.right - d3.left);
        r2 += t2, c2 += t2;
      }
      if (o2 > p2 && e2 < p2 && (r2 -= 0.5 * (o2 - p2), c2 -= 0.5 * (o2 - p2)), i2 > g2) {
  ...
  updateControls() {
    ...
    let d2 = { toggleMax: r2 - h2 < 0.5 * (c2 - h2) ? c2 : h2, toggleCover: r2 - h2 < 0.5 * (l2 - h2) ? l2 : h2, toggleZoom: r2 - h2 < 0.5 * (a2 - h2) ? a2 : h2 }[e2.option("click") || ""] || h2, u2 = e2.canZoomIn(), f2 = e2.canZoomOut(), p2 = n2 === O && !!this.option("touch"), g2 = f2 && p2;
    if (p2 && (t(r2) < t(h2) && !this.panOnlyZoomed && (g2 = true), (t(s2.width, 1) > t(s2.fitWidth, 1) || t(s2.height, 1) > t(s2.fitHeight, 1)) && (g2 = true)), t(s2.width * r2, 1) < t(s2.fitWidth, 1) && (g2 = false), n2 === M && (g2 = false), o(i2, this.cn("isDraggable"), g2), !this.option("zoom"))
      return;
    let m2 = u2 && t(d2) > t(r2), b2 = !m2 && !g2 && f2 && t(d2) < t(r2);
    o(i2, this.cn("canZoomIn"), m2), o(i2, this.cn("canZoomOut"), b2);
    ...
    for (const t2 of i2.querySelectorAll('[data-panzoom-action="zoomOut"]'))
      f2 ? (t2.removeAttribute("disabled"), t2.removeAttribute("tabindex")) : (t2.setAttribute("disabled", ""), t2.setAttribute("tabindex", "-1"));
    for (const t2 of i2.querySelectorAll('[data-panzoom-action="toggleZoom"],[data-panzoom-action="iterateZoom"]')) {
      u2 || f2 ? (t2.removeAttribute("disabled"), t2.removeAttribute("tabindex")) : (t2.setAttribute("disabled", ""), t2.setAttribute("tabindex", "-1"));
  ...
  applyChange({ panX: e2 = 0, panY: i2 = 0, scale: n2 = 1, angle: s2 = 0, originX: o2 = -this.current.e, originY: a2 = -this.current.f, friction: r2 = this.option("friction"), flipX: l2 = false, flipY: c2 = false, ignoreBounds: h2 = false, bounce: d2 = this.option("bounce") }) {
    ...
    const { current: f2 } = this, p2 = f2.e, g2 = f2.f, v2 = this.getMatrix(this.target);
    let y2 = new DOMMatrix().translate(p2, g2).translate(o2, a2).translate(e2, i2);
    if (this.option("zoom")) {
      if (!h2) {
    ...
    y2 = y2.translate(-o2, -a2).translate(-p2, -g2).multiply(v2), s2 && (y2 = y2.rotate(s2)), l2 && (y2 = y2.scale(-1, 1)), c2 && (y2 = y2.scale(1, -1));
    for (const e3 of b)
      "e" !== e3 && "f" !== e3 && (y2[e3] > this.minScale + 1e-5 || y2[e3] < this.minScale - 1e-5) ? this.target[e3] = y2[e3] : this.target[e3] = t(y2[e3], T);
    (this.targetScale < this.scale || Math.abs(n2 - 1) > 0.1 || this.panMode === M || false === d2) && !h2 && this.clampTargetBounds(), u2 === m.Init ? this.animate() : this.isResting || (this.state = m.Panning, this.requestTick());
  }
  stop(t2 = false) {
    ...
    this.setTransform(), E(this.container, "is-scaling"), E(this.container, "is-animating"), this.isTicking = false, this.state = m.Ready, e2 && (this.emit("endAnimation"), this.updateControls());
  }
  requestTick() {
  ...
  panWithMouse(e2, i2 = this.option("mouseMoveFriction")) {
    if (this.pmme = e2, this.panMode !== M || !e2)
      return;
    ...
    const f2 = this.option("mouseMoveFactor");
    f2 > 1 && (d2 !== a2 && (d2 *= f2), u2 !== r2 && (u2 *= f2));
    let p2 = 0.5 * (d2 - a2) - c2 / a2 * 100 / 100 * (d2 - a2);
    p2 += 0.5 * (o2.right - o2.left);
    let g2 = 0.5 * (u2 - r2) - h2 / r2 * 100 / 100 * (u2 - r2);
    g2 += 0.5 * (o2.bottom - o2.top), this.applyChange({ panX: p2 - this.target.e, panY: g2 - this.target.f, friction: i2 });
  }
  zoomWithWheel(e2) {
  ...
  zoomTo(t2 = 1, { friction: e2 = "auto", originX: i2 = "auto", originY: n2 = "auto", event: s2 } = {}) {
    ...
    this.stop();
    let a2 = 1;
    if (this.panMode === M && (s2 = this.pmme || s2), s2 || "auto" === i2 || "auto" === n2) {
    ...
    const r2 = this.fullScale, l2 = this.maxScale, c2 = this.coverScale;
    if ("number" == typeof t2)
      a2 = t2 / o2 || 1;
    else if ("full" === t2)
      a2 = r2 / o2 || 1;
      ...
      let t3 = [1, r2, l2].sort((t4, e4) => t4 - e4), e3 = t3.findIndex((t4) => t4 > o2 + 1e-5);
      a2 = t3[e3] / o2 || 1 / o2;
    }
    e2 = "auto" === e2 ? a2 > 1 ? 0.15 : 0.25 : e2, this.applyChange({ scale: a2, originX: i2, originY: n2, friction: e2 }), s2 && this.panMode === M && this.panWithMouse(s2, e2);
  }
  rotateCCW() {
...
var D = { viewport: null, track: null, enabled: true, slides: [], axis: "x", transition: "fade", preload: 1, slidesPerPage: "auto", initialPage: 0, friction: 0.12, Panzoom: { decelFriction: 0.12 }, center: true, infinite: true, fill: true, dragFree: false, adaptiveHeight: false, direction: "ltr", classes: { container: "f-carousel", viewport: "f-carousel__viewport", track: "f-carousel__track", slide: "f-carousel__slide", isLTR: "is-ltr", isRTL: "is-rtl", isHorizontal: "is-horizontal", isVertical: "is-vertical", inTransition: "in-transition", isSelected: "is-selected" }, l10n: { NEXT: "Next slide", PREV: "Previous slide", GOTO: "Go to slide #%d" } };
var F;
!function(t2) {
...
var _ = class extends B {
  ...
  build() {
    let t2 = this.list;
    if (!t2) {
      t2 = document.createElement("ul"), S(t2, this.cn("list")), t2.setAttribute("role", "tablist");
      const e2 = this.instance.container;
      e2.appendChild(t2), S(e2, this.cn("hasDots")), this.list = t2;
    }
    return t2;
  }
  refresh() {
...
var q = class extends B {
  ...
  addBtn(t2) {
    ...
    n2.setAttribute("tabindex", "0"), n2.setAttribute("title", i2.localize(`{{${t2.toUpperCase()}}}`)), S(n2, this.cn("button") + " " + this.cn(t2 === W ? "isNext" : "isPrev"));
    const s2 = i2.isRTL ? t2 === W ? X : W : t2;
    var o2;
  ...
  build() {
    ...
    i2 || (i2 = t2.querySelector("." + e2), this.isDom = !!i2), i2 || (i2 = document.createElement("div"), S(i2, e2), t2.appendChild(i2)), this.container = i2, s2 || (s2 = i2.querySelector("[data-carousel-next]")), s2 || (s2 = this.addBtn(W)), this.next = s2, n2 || (n2 = i2.querySelector("[data-carousel-prev]")), n2 || (n2 = this.addBtn(X)), this.prev = n2;
  }
  cleanup() {
...
var Y = class extends B {
  ...
  onTargetChange() {
    ...
    if (!i2 || !n2)
      return;
    if (n2.state !== F.Ready || i2.state !== F.Ready)
      return;
...
Object.defineProperty(Y, "defaults", { enumerable: true, configurable: true, writable: true, value: { friction: 0.35 } });
var V = { Navigation: q, Dots: _, Sync: Y };
var Z = "animationend";
var U = "isSelected";
var G = "slide";
var K = class _K extends g {
  ...
  processOptions() {
    var t2, e2;
    const i2 = u({}, _K.defaults, this.userOptions);
    let n2 = "";
  ...
  initLayout() {
    ...
    i2 || (i2 = document.createElement("div"), S(i2, e2.viewport), i2.append(...I(t2, `.${e2.slide}`)), t2.prepend(i2)), i2.addEventListener("scroll", this.onScroll);
  ...
  initSlides() {
    ...
    [...I(t2, `.${this.cn(G)}`)].forEach((t3) => {
      if (x(t3)) {
        const e3 = j({ el: t3, isDom: true, index: this.slides.length });
        i2.push(e3);
      }
    });
  ...
  getSlideMetrics(e2) {
    ...
    if (r2 ? o2 = parseFloat(r2.dataset[s2] || "") || 0 : (r2 = document.createElement("div"), r2.style.visibility = "hidden", (this.track || document.body).prepend(r2)), S(r2, this.cn(G) + " " + e2.class + " " + e2.customClass), o2)
  ...
  repositionSlides() {
    let e2, { isHorizontal: i2, isRTL: n2, isInfinite: s2, viewport: o2, viewportDim: a2, contentDim: r2, page: l2, pages: c2, slides: h2, panzoom: d2 } = this, u2 = 0, f2 = 0, p2 = 0, g2 = 0;
    d2 ? g2 = -1 * d2.current[this.axis] : c2[l2] && (g2 = c2[l2].pos || 0), e2 = i2 ? n2 ? "right" : "left" : "top", n2 && i2 && (g2 *= -1);
    for (const i3 of h2) {
      const n3 = i3.el;
      n3 ? ("top" === e2 ? (n3.style.right = "", n3.style.left = "") : n3.style.top = "", i3.index !== u2 ? n3.style[e2] = 0 === f2 ? "" : `${t(f2, 1e3)}px` : n3.style[e2] = "", p2 += i3.dim + i3.gap, u2++) : f2 += i3.dim + i3.gap;
    }
    if (s2 && p2 && o2) {
      ...
      for (const i3 of h2)
        i3.el && (t(i3.pos) < t(a2) && t(i3.pos + i3.dim + i3.gap) < t(g2) && t(g2) > t(r2 - a2) && (i3.el.style[e2] = `${t(f2 + p2, 1e3)}px`), t(i3.pos + i3.gap) >= t(r2 - a2) && t(i3.pos) > t(g2 + a2) && t(g2) < t(a2) && (i3.el.style[e2] = `-${t(p2, 1e3)}px`));
    }
    let m2, b2, v2 = [...this.inTransition];
    if (v2.length > 1 && (m2 = c2[v2[0]], b2 = c2[v2[1]]), m2 && b2) {
      let i3 = 0;
      for (const n3 of h2)
  ...
  createSlideEl(t2) {
    ...
    S(n2, this.cn(G)), S(n2, t2.class), S(n2, t2.customClass);
    const s2 = t2.html;
  ...
  transitionTo(t2 = 0, e2 = this.option("transition")) {
    ...
    const f2 = (null === (s2 = r2[a2]) || void 0 === s2 ? void 0 : s2.slides[0]) || null, p2 = (null === (o2 = r2[c2]) || void 0 === o2 ? void 0 : o2.slides[0]) || null;
    this.inTransition.add(p2.index), this.createSlideEl(p2);
    let g2 = f2.el, m2 = p2.el;
    u2 || e2 === G || (e2 = "fadeFast", g2 = null);
    const b2 = this.isRTL ? "next" : "prev", v2 = this.isRTL ? "prev" : "next";
    return g2 && (this.inTransition.add(f2.index), f2.transition = e2, g2.addEventListener(Z, this.onAnimationEnd), g2.classList.add(`f-${e2}Out`, `to-${h2 > 0 ? v2 : b2}`)), m2 && (p2.transition = e2, m2.addEventListener(Z, this.onAnimationEnd), m2.classList.add(`f-${e2}In`, `from-${h2 > 0 ? b2 : v2}`)), l2.current[this.axis] = d2, l2.target[this.axis] = d2, l2.requestTick(), this.onChange(c2), true;
  }
  ...
  markSelectedSlides() {
    ...
    if (e2)
      for (const i2 of this.slides) {
        const n2 = i2.el;
        n2 && (n2.dataset.index = `${i2.index}`, n2.classList.contains("f-thumbs__slide") ? this.getVisibleSlides(0).has(i2) ? n2.removeAttribute(t2) : n2.setAttribute(t2, "true") : this.pages[this.page].slides.includes(i2) ? (n2.classList.contains(e2) || (S(n2, e2), this.emit("selectSlide", i2)), n2.removeAttribute(t2)) : (n2.classList.contains(e2) && (E(n2, e2), this.emit("unselectSlide", i2)), n2.setAttribute(t2, "true")));
      }
  }
  flipInfiniteTrack() {
  ...
  onDecel(t2, e2 = 0, i2 = 0, n2 = 0, s2 = 0) {
    ...
    let f2 = this.page, p2 = o2 && a2 ? 1 : -1;
    const g2 = t2.target[r2] * p2, m2 = t2.current[r2] * p2;
    let { pageIndex: b2 } = this.getPageFromPosition(g2), { pageIndex: v2 } = this.getPageFromPosition(m2);
    u2 ? this.onChange(b2) : (Math.abs(d2) > 5 ? (l2[f2].dim < document.documentElement["client" + (this.isHorizontal ? "Width" : "Height")] - 1 && (f2 = v2), f2 = o2 && a2 ? d2 < 0 ? f2 - 1 : f2 + 1 : d2 < 0 ? f2 + 1 : f2 - 1) : f2 = 0 === n2 && 0 === s2 ? f2 : v2, this.slideTo(f2, { transition: false, friction: t2.option("decelFriction") }));
  }
  onClick(t2) {
  ...
  clearTransitions() {
    ...
    for (const e2 of this.slides) {
      const i2 = e2.el;
      if (i2) {
        i2.removeEventListener(Z, this.onAnimationEnd), i2.classList.remove(...t2);
  ...
  updateMetrics() {
    ...
    h2 = t(h2, 1e3), this.contentDim = h2, e2 && (e2.contentRect[r2] = h2, e2.contentRect["e" === this.axis ? "fullWidth" : "fullHeight"] = h2), this.pages = this.createPages(), this.pages = this.processPages(), this.state === F.Init && this.setInitialPage(), this.page = Math.max(0, Math.min(this.page, this.pages.length - 1)), this.manageSlideVisiblity(), this.emit("refresh");
  }
  ...
  getVisibleSlides(t2 = 0) {
    ...
    let r2 = 0;
    r2 = this.panzoom && this.panzoom.state !== m.Init && this.panzoom.state !== m.Destroy ? -1 * this.panzoom.current[this.axis] : o2[a2] && o2[a2].pos || 0, this.isInfinite && (r2 -= Math.floor(r2 / n2) * n2), this.isRTL && this.isHorizontal && (r2 *= -1);
    const l2 = r2 - s2 * t2, c2 = r2 + s2 * (t2 + 1), h2 = this.isInfinite ? [-1, 0, 1] : [0];
    for (const t3 of this.slides)
      for (const e3 of h2) {
        const s3 = t3.pos + e3 * n2, o3 = s3 + t3.dim + t3.gap;
  ...
  getPageFromPosition(t2) {
    var e2;
    const { viewportDim: i2, contentDim: n2 } = this, s2 = this.pages.length, o2 = this.slides.length, a2 = this.slides[o2 - 1];
    let r2 = 0, l2 = 0, c2 = 0;
    const h2 = this.option("center");
    h2 && (t2 += 0.5 * i2), this.isInfinite || (t2 = Math.max((null === (e2 = this.slides[0]) || void 0 === e2 ? void 0 : e2.pos) || 0, Math.min(t2, a2.pos)));
    const d2 = n2 + a2.gap;
    c2 = Math.floor(t2 / d2) || 0, t2 -= c2 * d2;
    let u2 = a2, f2 = this.slides.find((e3) => {
      const i3 = t2 + (u2 && !h2 ? 0.5 * u2.dim : 0);
      return u2 = e3, e3.pos <= i3 && e3.pos + e3.dim + e3.gap > i3;
    });
    return f2 || (f2 = a2), l2 = this.getPageForSlide(f2.index), r2 = l2 + c2 * s2, { page: r2, pageIndex: l2 };
  }
  destroy() {
...
Object.defineProperty(K, "Panzoom", { enumerable: true, configurable: true, writable: true, value: R }), Object.defineProperty(K, "defaults", { enumerable: true, configurable: true, writable: true, value: D }), Object.defineProperty(K, "Plugins", { enumerable: true, configurable: true, writable: true, value: V });
var J = function(t2) {
  if (!x(t2))
    return 0;
...
var tt;
var et = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden]):not(.fancybox-focus-guard)", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"]):not([disabled]):not([aria-hidden])'].join(",");
var it = (t2) => {
  if (t2 && Q) {
    void 0 === tt && document.createElement("div").focus({ get preventScroll() {
...
var at = () => {
  queueMicrotask(() => {
    (() => {
      const { slug: t2, index: e2 } = rt.parseURL(), i2 = ce.getInstance();
      if (i2 && false !== i2.option("Hash")) {
        ...
        rt.hasSilentClose = true, i2.close();
      }
      rt.startFromUrl();
    })();
  });
};
var rt = class _rt extends B {
  constructor() {
  ...
  onChange() {
    ...
    o2 && "true" !== o2 && (l2 = "#" + o2 + (!a2 && e2.slides.length > 1 ? "-" + (i2.index + 1) : "")), n2 && (this.origHash = s2 !== l2 ? s2 : ""), l2 && s2 !== l2 && (this.timer = setTimeout(() => {
      try {
        t2.state === st.Ready && window.history[n2 ? "pushState" : "replaceState"]({}, document.title, window.location.pathname + window.location.search + l2);
      } catch (t3) {
      }
    }, 300));
  }
  onClose() {
    if (this.timer && clearTimeout(this.timer), true !== _rt.hasSilentClose)
      try {
  ...
  attach() {
    ...
    t2.on(["Carousel.ready", "Carousel.change"], this.onChange), t2.on("close", this.onClose);
  }
  detach() {
    const t2 = this.instance;
    t2.off(["Carousel.ready", "Carousel.change"], this.onChange), t2.off("close", this.onClose);
  }
  static parseURL() {
  ...
  static startFromUrl() {
    if (_rt.hasSilentClose = false, ce.getInstance() || false === ce.defaults.Hash)
      return;
    const { hash: t2, slug: e2, index: i2 } = _rt.parseURL();
    if (!e2)
      return;
    let n2 = document.querySelector(`[data-slug="${t2}"]`);
    if (n2 && n2.dispatchEvent(new CustomEvent("click", { bubbles: true, cancelable: true })), ce.getInstance())
      return;
...
Object.defineProperty(rt, "defaults", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(rt, "hasSilentClose", { enumerable: true, configurable: true, writable: true, value: false }), Q && (/complete|interactive|loaded/.test(document.readyState) ? lt() : document.addEventListener("DOMContentLoaded", lt));
var ct = "is-zooming-in";
var ht = class extends B {
  ...
  onClose() {
    ...
    if (!l2)
      return;
    this.instance.state = st.CustomClosing, i2.classList.remove(ct), i2.classList.add("is-zooming-out"), o2.style.backgroundImage = `url('${r2}')`;
    const c2 = i2.getBoundingClientRect();
    1 === ((null === (t2 = window.visualViewport) || void 0 === t2 ? void 0 : t2.scale) || 1) && Object.assign(i2.style, { position: "absolute", top: `${window.scrollY}px`, left: `${window.scrollX}px`, bottom: "auto", right: "auto", width: `${c2.width}px`, height: `${c2.height}px`, overflow: "hidden" });
    const { x: h2, y: d2, scale: u2, opacity: f2 } = l2;
    if (f2) {
    ...
    a2.on("endAnimation", () => {
      e2.destroy();
    }), a2.target.a = u2, a2.target.b = 0, a2.target.c = 0, a2.target.d = u2, a2.panTo({ x: h2, y: d2, scale: u2, friction: f2 ? 0.2 : 0.33, ignoreBounds: true }), a2.isResting && e2.destroy();
  }
  setImage(t2, e2) {
    ...
    t2.src = e2, this.process(t2, e2).then((e3) => {
      ...
      if (this.option("protected") && a2) {
        ...
        S(t3, "fancybox-protected"), n2.appendChild(t3);
      }
      if (o2 && r2) {
        const s3 = e3.contentRect, a3 = Math.max(s3.fullWidth, s3.fullHeight);
        let c2 = null;
        !r2.opacity && a3 > 1200 && (c2 = document.createElement("img"), S(c2, "fancybox-ghost"), c2.src = o2, n2.appendChild(c2));
        const h2 = () => {
        ...
        (l2 = o2, new Promise((t3, e4) => {
          ...
          i2.hideLoading(t2), t2.state = ot.Opening, this.instance.emit("reveal", t2), this.zoomIn(t2).then(() => {
    ...
    return new Promise((i2, s2) => {
      ...
      if ("string" == typeof l2 && (l2 = n(l2)), !l2 || !x(l2)) {
        if (l2 = document.createElement("img"), l2 instanceof HTMLImageElement) {
          ...
          i3 = "string" == typeof n2 && n2 ? n2.replace(/<[^>]+>/gi, "").substring(0, 1e3) : `Image ${t2.index + 1} of ${null === (o2 = a2.carousel) || void 0 === o2 ? void 0 : o2.pages.length}`, l2.src = e2 || "", l2.alt = i3, l2.draggable = false, t2.srcset && l2.setAttribute("srcset", t2.srcset), this.instance.isOpeningSlide(t2) && (l2.fetchPriority = "high");
        }
        t2.sizes && l2.setAttribute("sizes", t2.sizes);
      }
      S(l2, "fancybox-image"), t2.imageEl = l2, a2.setContent(t2, l2, false);
  ...
  zoomIn(t2) {
    return new Promise((e2, i2) => {
      ...
      if (!(l2 && r2 && a2 && o2 && s2))
        return void i2();
      const { x: c2, y: h2, scale: d2, opacity: u2 } = l2, f2 = () => {
        t2.state !== ot.Closing && (u2 && (a2.style.opacity = Math.max(Math.min(1, 1 - (1 - o2.scale) / (1 - d2)), 0) + ""), o2.scale >= 1 && o2.scale > o2.targetScale - 0.1 && e2(o2));
      }, p2 = (t3) => {
        (t3.scale < 0.99 || t3.scale > 1.01) && !t3.isDragging || (E(s2, ct), a2.style.opacity = "", t3.off("endAnimation", p2), t3.off("touchStart", p2), t3.off("afterTransform", f2), e2(t3));
      };
      o2.on("endAnimation", p2), o2.on("touchStart", p2), o2.on("afterTransform", f2), o2.on(["error", "destroy"], () => {
        i2();
      ...
      S(s2, ct), n2.hideLoading(t2), "full" === m2 ? o2.zoomToFull(g2) : "cover" === m2 ? o2.zoomToCover(g2) : "max" === m2 ? o2.zoomToMax(g2) : o2.reset(0.172);
    });
  }
  getZoomInfo(t2) {
    var e2;
    const { el: i2, imageEl: n2, thumbEl: s2, panzoom: o2 } = t2;
    if (!i2 || !n2 || !s2 || !o2 || J(s2) < 3 || !this.optionFor(t2, "zoom") || this.instance.state === st.Destroy)
      return false;
    if (1 !== ((null === (e2 = window.visualViewport) || void 0 === e2 ? void 0 : e2.scale) || 1))
      return false;
    let { top: a2, left: r2, width: l2, height: c2 } = s2.getBoundingClientRect(), { top: h2, left: d2, fitWidth: u2, fitHeight: f2 } = o2.contentRect;
    if (!(l2 && c2 && u2 && f2))
      return false;
    const p2 = o2.container.getBoundingClientRect();
    d2 += p2.left, h2 += p2.top;
    const g2 = -1 * (d2 + 0.5 * u2 - (r2 + 0.5 * l2)), m2 = -1 * (h2 + 0.5 * f2 - (a2 + 0.5 * c2)), b2 = l2 / u2;
    let v2 = this.option("zoomOpacity") || false;
    return "auto" === v2 && (v2 = Math.abs(l2 / c2 - u2 / f2) > 0.1), { x: g2, y: m2, scale: b2, opacity: v2 };
  }
  attach() {
...
Object.defineProperty(ht, "defaults", { enumerable: true, configurable: true, writable: true, value: { initialSize: "fit", Panzoom: { maxScale: 1 }, protected: false, zoom: true, zoomOpacity: "auto" } }), "function" == typeof SuppressedError && SuppressedError;
var dt = "html";
var ut = "image";
var ft = "map";
var pt = "youtube";
...
var vt = { ajax: null, autoSize: true, iframeAttr: { allow: "autoplay; fullscreen", scrolling: "auto" }, preload: true, videoAutoplay: true, videoRatio: 16 / 9, videoTpl: `<video class="fancybox__html5video" playsinline controls controlsList="nodownload" poster="{{poster}}">
...
var yt = ["image", "html", "ajax", "inline", "clone", "iframe", "map", "pdf", "html5video", "youtube", "vimeo"];
var wt = class extends B {
  ...
  onSelectSlide(t2, e2, i2) {
    i2.state === ot.Ready && this.playVideo();
  }
  onUnselectSlide(t2, e2, i2) {
    ...
    let o2;
    i2.type === gt ? o2 = { method: "pause", value: "true" } : i2.type === pt && (o2 = { event: "command", func: "pauseVideo" }), o2 && i2.iframeEl && i2.iframeEl.contentWindow && i2.iframeEl.contentWindow.postMessage(JSON.stringify(o2), "*"), i2.poller && clearTimeout(i2.poller);
  }
  onDone(t2, e2) {
  ...
  loadAjaxContent(t2) {
    ...
    i2.showLoading(t2), n2.onreadystatechange = function() {
      n2.readyState === XMLHttpRequest.DONE && i2.state === st.Ready && (i2.hideLoading(t2), 200 === n2.status ? i2.setContent(t2, n2.responseText) : i2.setError(t2, 404 === n2.status ? "{{AJAX_NOT_FOUND}}" : "{{AJAX_FORBIDDEN}}"));
    };
  ...
  resizeIframe(t2) {
    ...
    if (false !== t2.preload && false !== s2 && r2)
      try {
        ...
        if (l2) {
          const t4 = l2.document, i3 = t4.getElementsByTagName(dt)[0], n3 = t4.body;
  ...
  processType(t2) {
    if (t2.html)
      return t2.type = dt, t2.src = t2.html, void (t2.html = "");
    const e2 = this.instance.optionFor(t2, "src", "");
    ...
    if (n2 = e2.match(/(youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|shorts\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i)) {
      const s2 = this.optionFor(t2, pt), { nocookie: o2 } = s2, a2 = function(t3, e3) {
        ...
        return i3;
      }(s2, ["nocookie"]), r2 = `www.youtube${o2 ? "-nocookie" : ""}.com`, l2 = bt(e2, a2), c2 = encodeURIComponent(n2[2]);
      ...
      const s2 = bt(e2, this.optionFor(t2, gt)), o2 = encodeURIComponent(n2[1]), a2 = n2[4] || "";
      t2.videoId = o2, t2.src = `https://player.vimeo.com/video/${o2}?${a2 ? `h=${a2}${s2 ? "&" : ""}` : ""}${s2}`, i2 = gt;
    }
    if (!i2 && t2.triggerEl) {
      const e3 = t2.triggerEl.dataset.type;
      yt.includes(e3) && (i2 = e3);
    }
    i2 || "string" == typeof e2 && ("#" === e2.charAt(0) ? i2 = "inline" : (n2 = e2.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (i2 = mt, t2.videoFormat = t2.videoFormat || "video/" + ("ogv" === n2[1] ? "ogg" : n2[1])) : e2.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? i2 = ut : e2.match(/\.(pdf)((\?|#).*)?$/i) && (i2 = "pdf")), (n2 = e2.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:(?:(?:maps\/(?:place\/(?:.*)\/)?\@(.*),(\d+.?\d+?)z))|(?:\?ll=))(.*)?/i)) ? (t2.src = `https://maps.google.${n2[1]}/?ll=${(n2[2] ? n2[2] + "&z=" + Math.floor(parseFloat(n2[3])) + (n2[4] ? n2[4].replace(/^\//, "&") : "") : n2[4] + "").replace(/\?/, "&")}&output=${n2[4] && n2[4].indexOf("layer=c") > 0 ? "svembed" : "embed"}`, i2 = ft) : (n2 = e2.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:maps\/search\/)(.*)/i)) && (t2.src = `https://maps.google.${n2[1]}/maps?q=${n2[2].replace("query=", "q=").replace("api=1", "")}&output=embed`, i2 = ft), i2 = i2 || this.instance.option("defaultType"), t2.type = i2, i2 === ut && (t2.thumbSrc = t2.thumbSrc || t2.src);
  }
  setContent(t2) {
    const e2 = this.instance.optionFor(t2, "src") || "";
    if (t2 && t2.type && e2) {
  ...
  setAspectRatio(t2) {
    ...
    if (!(t2.el && e2 && t2.type && [pt, gt, mt].includes(t2.type)))
      return;
...
var Pt = class extends B {
  ...
  set() {
    ...
    t2.state = xt, S(e2.container, "has-autoplay");
  ...
  stop() {
    ...
    t2.clear(), t2.state = St, i2.removeEventListener("mouseenter", t2.onMouseEnter, false), i2.removeEventListener("mouseleave", t2.onMouseLeave, false), document.removeEventListener("visibilitychange", t2.onVisibilityChange, false), E(i2, "has-autoplay"), e2 !== St && t2.emit("stop");
  }
  pause() {
    const t2 = this;
    t2.state === xt && (t2.state = Et, t2.clear(), t2.emit(Et));
  }
  resume() {
    const t2 = this, e2 = t2.instance;
    if (e2.isInfinite || e2.page !== e2.pages.length - 1)
      if (t2.state !== xt) {
        if (t2.state === Et && !t2.inHover) {
...
Object.defineProperty(Pt, "defaults", { enumerable: true, configurable: true, writable: true, value: { autoStart: true, pauseOnHover: true, progressParentEl: null, showProgress: true, timeout: 3e3 } });
var Ct = class extends B {
  ...
  onPrepare(t2) {
    ...
    i2 && (e2.options.Autoplay = u({ autoStart: false }, this.option("Autoplay") || {}, { pauseOnHover: false, timeout: this.option("timeout"), progressParentEl: () => this.option("progressParentEl") || null, on: { start: () => {
      ...
      var n2;
      i2.classList.add("has-slideshow"), (null === (n2 = t2.getSlide()) || void 0 === n2 ? void 0 : n2.state) !== ot.Ready && e3.pause();
    }, stop: () => {
      i2.classList.remove("has-slideshow"), t2.isCompact || t2.endIdle(), t2.emit("endSlideshow");
    }, resume: (e3, i3) => {
      var n2, s2, o2;
      !i3 || !i3.cancelable || (null === (n2 = t2.getSlide()) || void 0 === n2 ? void 0 : n2.state) === ot.Ready && (null === (o2 = null === (s2 = t2.carousel) || void 0 === s2 ? void 0 : s2.panzoom) || void 0 === o2 ? void 0 : o2.isResting) || i3.preventDefault();
    } } }), e2.attachPlugins({ Autoplay: Pt }), this.ref = e2.plugins.Autoplay);
  }
  onReady(t2) {
...
Object.defineProperty(Ct, "defaults", { enumerable: true, configurable: true, writable: true, value: { key: " ", playOnStart: false, progressParentEl: (t2) => {
  var e2;
...
var Rt = class extends B {
  ...
  onInitSlide(t2, e2) {
    ...
    i2 && (e2.thumbSrc = i2.thumbSrc || e2.thumbSrc || "", e2[zt] = parseFloat(i2[zt] || "") || e2[zt] || 0, e2[Lt] = parseFloat(i2.thumbHeight || "") || e2[Lt] || 0), this.addSlide(e2);
  }
  onInitSlides() {
    this.build();
  }
  onChange() {
    ...
    if (n2 && s2 && a2) {
      if (n2.isDragging) {
        ...
        n3 += i2.getProgress(r2) * (this[zt] + this.thumbGap);
        let o2 = a2.getBounds();
        -1 * n3 > o2.x.min && -1 * n3 < o2.x.max && a2.panTo({ x: -1 * n3, friction: 0.12 });
      } else
        o(e2, this.cn(Ot), n2.isResting);
      this.shiftModern();
    }
  }
  onRefresh() {
  ...
  resizeModernSlide(t2) {
    this.isModern && (t2[At] = t2[zt] && t2[Lt] ? Math.round(this[Lt] * (t2[zt] / t2[Lt])) : this[At]);
  }
  updateProps() {
    const t2 = this.container;
    if (!t2)
    ...
    this.thumbGap = e2("gap"), this.thumbExtraGap = e2("extra-gap"), this[At] = e2("width") || 40, this[zt] = e2("clip-width") || 40, this[Lt] = e2("height") || 40;
  }
  build() {
    const t2 = this;
    if (t2.state !== Mt.Init)
    ...
    S(o2, t2.cn("container")), S(o2, `is-${s2}`);
    const a2 = t2.option("parentEl");
    a2 ? a2.appendChild(o2) : i2.after(o2), S(i2, t2.cn("hasThumbs")), t2.container = o2, t2.updateProps();
    const r2 = document.createElement("div");
    S(r2, t2.cn("track")), o2.appendChild(r2), t2.track = r2;
    const l2 = u({}, { track: r2, infinite: false, center: true, fill: "classic" === s2, dragFree: true, slidesPerPage: 1, transition: false, preload: 0.25, friction: 0.12, Panzoom: { maxVelocity: 0 }, Dots: false, Navigation: false, classes: { container: "f-thumbs", viewport: "f-thumbs__viewport", track: "f-thumbs__track", slide: "f-thumbs__slide" } }, t2.option("Carousel") || {}, { Sync: { target: e2 }, slides: n2 }), c2 = new e2.constructor(o2, l2);
    c2.on("createSlide", (e3, i3) => {
      t2.setProps(i3.index), t2.emit("createSlide", i3, i3.el);
    }), c2.on("ready", () => {
      t2.shiftModern(), t2.emit("ready");
    }), c2.on("refresh", () => {
      t2.shiftModern();
    }), c2.on("Panzoom.click", (e3, i3, n3) => {
      t2.onClick(n3);
    }), t2.carousel = c2, t2.state = Mt.Ready;
  }
  onClick(t2) {
    ...
    if (a2 > -1)
      return;
    const l2 = this[zt], c2 = t2.clientX, h2 = t2.clientY;
    let [d2, u2] = o2(c2 - l2, h2), [f2, p2] = o2(c2 + l2, h2);
    u2 && p2 ? (a2 = Math.abs(c2 - u2.getBoundingClientRect().right) < Math.abs(c2 - p2.getBoundingClientRect().left) ? d2 : f2, a2 === n2 && (a2 = a2 === d2 ? f2 : d2)) : u2 ? a2 = d2 : p2 && (a2 = f2), a2 > -1 && i2[a2] && e2.slideTo(a2);
  }
  getShift(t2) {
    var e2;
    ...
    if (!n2 || !s2)
      return 0;
    const o2 = i2[At], a2 = i2[zt], r2 = i2.thumbGap, l2 = i2.thumbExtraGap;
    if (!(null === (e2 = s2.slides[t2]) || void 0 === e2 ? void 0 : e2.el))
      return 0;
    const c2 = 0.5 * (o2 - a2), h2 = n2.pages.length - 1;
    let d2 = n2.getProgress(0), u2 = n2.getProgress(h2), f2 = n2.getProgress(t2, false, true), p2 = 0, g2 = c2 + l2 + r2;
    const m2 = d2 < 0 && d2 > -1, b2 = u2 > 0 && u2 < 1;
    return 0 === t2 ? (p2 = g2 * Math.abs(d2), b2 && 1 === d2 && (p2 -= g2 * Math.abs(u2))) : t2 === h2 ? (p2 = g2 * Math.abs(u2) * -1, m2 && -1 === u2 && (p2 += g2 * Math.abs(d2))) : m2 || b2 ? (p2 = -1 * g2, p2 += g2 * Math.abs(d2), p2 += g2 * (1 - Math.abs(u2))) : p2 = g2 * f2, p2;
  }
  setProps(e2) {
    const i2 = this;
    if (!i2.isModern)
      return;
    const { instance: n2 } = i2, s2 = i2.carousel;
    if (n2 && s2) {
      const o2 = s2.slides[e2].el;
      if (o2 && o2.childNodes.length) {
        let s3 = t(1 - Math.abs(n2.getProgress(e2))), a2 = t(i2.getShift(e2));
        o2.style.setProperty("--progress", s3 ? s3 + "" : ""), o2.style.setProperty("--shift", a2 + "");
      }
    }
  }
  shiftModern() {
    ...
    let o2 = (t2[zt] + t2.thumbGap) * (s2.slides.length || 0);
    i2.style.setProperty("--width", o2 + "");
  }
  cleanup() {
    const t2 = this;
    t2.carousel && t2.carousel.destroy(), t2.carousel = null, t2.container && t2.container.remove(), t2.container = null, t2.track && t2.track.remove(), t2.track = null, t2.state = Mt.Init, E(t2.instance.container, t2.cn("hasThumbs"));
  }
  attach() {
    const t2 = this, e2 = t2.instance;
    e2.on("initSlide", t2.onInitSlide), e2.state === F.Init ? e2.on("initSlides", t2.onInitSlides) : t2.onInitSlides(), e2.on(["change", "Panzoom.afterTransform"], t2.onChange), e2.on("Panzoom.refresh", t2.onRefresh);
  }
  detach() {
    const t2 = this, e2 = t2.instance;
...
Object.defineProperty(Rt, "defaults", { enumerable: true, configurable: true, writable: true, value: Tt });
var kt = Object.assign(Object.assign({}, Tt), { key: "t", showOnStart: true, parentEl: null });
var It = "is-masked";
var Dt = "aria-hidden";
var Ft = class extends B {
  ...
  onCreateSlide(t2, e2) {
    ...
    if (a2 && o2) {
      let t3 = `for-${o2}`;
      ["video", "youtube", "vimeo", "html5video"].includes(o2) && (t3 += " for-video"), S(a2, t3);
    }
  }
  onInit() {
    var t2;
    ...
    o2.Carousel = o2.Carousel || {}, o2.Carousel.on = u((null === (t2 = e2.options.Carousel) || void 0 === t2 ? void 0 : t2.on) || {}, { click: this.onClick, createSlide: this.onCreateSlide }), n2.options.Thumbs = o2, n2.attachPlugins({ Thumbs: Rt }), e2.ref = n2.plugins.Thumbs, e2.option("showOnStart") || (e2.ref.state = Mt.Hidden, e2.hidden = true);
  }
  onResize() {
    var t2;
  ...
  toggle() {
    const t2 = this.ref;
    if (t2 && !t2.isDisabled())
      return t2.state === Mt.Hidden ? (t2.state = Mt.Init, void t2.build()) : void (this.hidden ? this.show() : this.hide());
  }
  show() {
    const t2 = this.ref;
    if (!t2 || t2.isDisabled())
    ...
    e2 && (this.refresh(), e2.offsetHeight, e2.removeAttribute(Dt), e2.classList.remove(It), this.hidden = false);
  }
  hide() {
    const t2 = this.ref, e2 = t2 && t2.container;
    e2 && (this.refresh(), e2.offsetHeight, e2.classList.add(It), e2.setAttribute(Dt, "true")), this.hidden = true;
  }
  refresh() {
    const t2 = this.ref;
    if (!t2 || !t2.state)
  ...
  attach() {
    const t2 = this, e2 = t2.instance;
    e2.state === st.Init ? e2.on("Carousel.init", t2.onInit) : t2.onInit(), e2.on("resize", t2.onResize), e2.on("keydown", t2.onKeydown);
  }
  detach() {
    var t2;
...
Object.defineProperty(Ft, "defaults", { enumerable: true, configurable: true, writable: true, value: kt });
...
var Bt = { absolute: "auto", display: { left: ["infobar"], middle: [], right: ["iterateZoom", "slideshow", "fullscreen", "thumbs", "close"] }, enabled: "auto", items: { infobar: { tpl: '<div class="fancybox__infobar" tabindex="-1"><span data-fancybox-current-index></span>/<span data-fancybox-count></span></div>' }, download: { tpl: '<a class="f-button" title="{{DOWNLOAD}}" data-fancybox-download href="javasript:;"><svg><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2M7 11l5 5 5-5M12 4v12"/></svg></a>' }, prev: { tpl: '<button class="f-button" title="{{PREV}}" data-fancybox-prev><svg><path d="m15 6-6 6 6 6"/></svg></button>' }, next: { tpl: '<button class="f-button" title="{{NEXT}}" data-fancybox-next><svg><path d="m9 6 6 6-6 6"/></svg></button>' }, slideshow: { tpl: '<button class="f-button" title="{{TOGGLE_SLIDESHOW}}" data-fancybox-toggle-slideshow><svg><g><path d="M8 4v16l13 -8z"></path></g><g><path d="M8 4v15M17 4v15"/></g></svg></button>' }, fullscreen: { tpl: '<button class="f-button" title="{{TOGGLE_FULLSCREEN}}" data-fancybox-toggle-fullscreen><svg><g><path d="M4 8V6a2 2 0 0 1 2-2h2M4 16v2a2 2 0 0 0 2 2h2M16 4h2a2 2 0 0 1 2 2v2M16 20h2a2 2 0 0 0 2-2v-2"/></g><g><path d="M15 19v-2a2 2 0 0 1 2-2h2M15 5v2a2 2 0 0 0 2 2h2M5 15h2a2 2 0 0 1 2 2v2M5 9h2a2 2 0 0 0 2-2V5"/></g></svg></button>' }, thumbs: { tpl: '<button class="f-button" title="{{TOGGLE_THUMBS}}" data-fancybox-toggle-thumbs><svg><circle cx="5.5" cy="5.5" r="1"/><circle cx="12" cy="5.5" r="1"/><circle cx="18.5" cy="5.5" r="1"/><circle cx="5.5" cy="12" r="1"/><circle cx="12" cy="12" r="1"/><circle cx="18.5" cy="12" r="1"/><circle cx="5.5" cy="18.5" r="1"/><circle cx="12" cy="18.5" r="1"/><circle cx="18.5" cy="18.5" r="1"/></svg></button>' }, close: { tpl: '<button class="f-button" title="{{CLOSE}}" data-fancybox-close><svg><path d="m19.5 4.5-15 15M4.5 4.5l15 15"/></svg></button>' } }, parentEl: null };
var Nt = { tabindex: "-1", width: "24", height: "24", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" };
var _t = class extends B {
  constructor() {
    super(...arguments), Object.defineProperty(this, "state", { enumerable: true, configurable: true, writable: true, value: Ht.Init }), Object.defineProperty(this, "container", { enumerable: true, configurable: true, writable: true, value: null });
  }
  onReady(t2) {
    var e2;
    if (!t2.carousel)
    ...
    if (o2 && (r2 = this.createContainer()), r2) {
      ...
      true === n2 && S(r2, "is-absolute"), this.state = Ht.Ready, this.onRefresh();
    } else
      this.state = Ht.Disabled;
  }
  onClick(t2) {
    var e2, i2;
  ...
  createEl(t2) {
    ...
    if (l2)
      for (const [t3, e3] of Object.entries(Nt))
        l2.getAttribute(t3) || l2.setAttribute(t3, String(e3));
    return s2;
  }
  removeContainer() {
    const t2 = this.container;
    t2 && t2.remove(), this.container = null, this.state = Ht.Disabled;
    const e2 = this.instance.container;
    e2 && E(e2, "has-toolbar");
  }
  attach() {
...
Object.defineProperty(_t, "defaults", { enumerable: true, configurable: true, writable: true, value: Bt });
var $t = { Hash: rt, Html: wt, Images: ht, Slideshow: Ct, Thumbs: Ft, Toolbar: _t };
var Wt = "with-fancybox";
var Xt = "hide-scrollbar";
var qt = "--fancybox-scrollbar-compensate";
var Yt = "--fancybox-body-margin";
var Vt = "is-using-tab";
var Zt = "is-animated";
var Ut = "is-compact";
var Gt = "is-loading";
...
var ce = class _ce extends g {
  ...
  constructor(t2 = [], e2 = {}, i2 = {}) {
    super(e2), Object.defineProperty(this, "userSlides", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "userPlugins", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "idle", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "idleTimer", { enumerable: true, configurable: true, writable: true, value: null }), Object.defineProperty(this, "clickTimer", { enumerable: true, configurable: true, writable: true, value: null }), Object.defineProperty(this, "pwt", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "ignoreFocusChange", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "state", { enumerable: true, configurable: true, writable: true, value: st.Init }), Object.defineProperty(this, "id", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "container", { enumerable: true, configurable: true, writable: true, value: null }), Object.defineProperty(this, "footer", { enumerable: true, configurable: true, writable: true, value: null }), Object.defineProperty(this, "caption", { enumerable: true, configurable: true, writable: true, value: null }), Object.defineProperty(this, "carousel", { enumerable: true, configurable: true, writable: true, value: null }), Object.defineProperty(this, "lastFocus", { enumerable: true, configurable: true, writable: true, value: null }), Object.defineProperty(this, "prevMouseMoveEvent", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "fsAPI", { enumerable: true, configurable: true, writable: true, value: void 0 }), this.fsAPI = (() => {
      let t3, e3 = "", i3 = "", n2 = "";
    ...
    })(), this.id = e2.id || ++le, re.set(this.id, this), this.userSlides = t2, this.userPlugins = i2, queueMicrotask(() => {
      this.init();
    });
  }
  init() {
    if (this.state === st.Destroy)
      return;
    this.state = st.Init, this.attachPlugins(Object.assign(Object.assign({}, _ce.Plugins), this.userPlugins)), this.emit("init"), this.emit("attachPlugins"), true === this.option("hideScrollbar") && (() => {
      if (!Q)
        return;
      const t3 = document, e3 = t3.body, i2 = t3.documentElement;
      if (e3.classList.contains(Xt))
        return;
      let n2 = window.innerWidth - i2.getBoundingClientRect().width;
      const s2 = parseFloat(window.getComputedStyle(e3).marginRight);
      n2 < 0 && (n2 = 0), i2.style.setProperty(qt, `${n2}px`), s2 && e3.style.setProperty(Yt, `${s2}px`), e3.classList.add(Xt);
  ...
  initLayout() {
    ...
    s2 && (s2.setAttribute("id", `fancybox-${this.id}`), s2.setAttribute("aria-label", this.localize("{{MODAL}}")), s2.classList.toggle(Ut, this.isCompact), S(s2, this.option("mainClass") || ""), this.container = s2, this.footer = s2.querySelector(".fancybox__footer"), i2.appendChild(s2), S(document.documentElement, Wt), oe && ae || (oe = document.createElement("span"), S(oe, "fancybox-focus-guard"), oe.setAttribute(Qt, "0"), oe.setAttribute("aria-hidden", "true"), oe.setAttribute("aria-label", "Focus guard"), ae = oe.cloneNode(), null === (t2 = s2.parentElement) || void 0 === t2 || t2.insertBefore(oe, s2), null === (e2 = s2.parentElement) || void 0 === e2 || e2.append(ae)), s2.addEventListener("mousedown", () => {
      E(s2, Vt);
    }), this.option("animated") && (S(s2, Zt), setTimeout(() => {
      this.isClosing() || E(s2, Zt);
  ...
  initCarousel(t2) {
    ...
    if (!n2)
      return;
    const s2 = this.carousel = new K(n2, u({}, { slides: t2, transition: "fade", Panzoom: { lockAxis: this.option("dragToClose") ? "xy" : "x", infinite: !!this.option("dragToClose") && "y" }, Dots: false, Navigation: { classes: { container: "fancybox__nav", button: "f-button", isNext: "is-next", isPrev: "is-prev" } }, initialPage: this.option("startIndex"), l10n: this.option("l10n") }, this.option("Carousel") || {}));
    s2.on("*", (t3, e2, ...i3) => {
      ...
      if (!t3.isInfinite) {
        for (const i4 of e2.querySelectorAll("[data-fancybox-next]"))
          t3.page < t3.pages.length - 1 ? (i4.removeAttribute(Jt), i4.removeAttribute(Qt)) : (i4.setAttribute(Jt, ""), i4.setAttribute(Qt, "-1"));
        for (const i4 of e2.querySelectorAll("[data-fancybox-prev]"))
          t3.page > 0 ? (i4.removeAttribute(Jt), i4.removeAttribute(Qt)) : (i4.setAttribute(Jt, ""), i4.setAttribute(Qt, "-1"));
      }
      const i3 = this.getSlide();
      if (!i3)
        return;
      let n3 = i3.downloadSrc || "";
      n3 || "image" !== i3.type || i3.error || !ne(i3[ie]) || (n3 = i3[ie]);
      for (const t4 of e2.querySelectorAll("[data-fancybox-download]")) {
        const e3 = i3.downloadFilename;
        n3 ? (t4.removeAttribute(Jt), t4.removeAttribute(Qt), t4.setAttribute(ee, n3), t4.setAttribute(te, e3 || n3), t4.setAttribute("target", "_blank")) : (t4.setAttribute(Jt, ""), t4.setAttribute(Qt, "-1"), t4.removeAttribute(ee), t4.removeAttribute(te));
      }
    ...
    if (o2.closest(".fancybox__content")) {
      if (a2) {
        if (a2.closest("[contenteditable]"))
          return;
        o2.matches(et) || a2.blur();
      }
      if (se())
        return;
      r2 = this.option("contentClick");
    } else
      o2.closest(".fancybox__carousel") && !o2.matches(et) && (r2 = this.option("backdropClick"));
  ...
  onKeydown(t2) {
    ...
    if ("Tab" === t2.key ? S(this.container, Vt) : E(this.container, Vt), t2.ctrlKey || t2.altKey || t2.shiftKey)
      return;
  ...
  onResize() {
    ...
    t2.classList.toggle(Ut, e2), this.manageCaption(this.getSlide()), this.isCompact ? this.clearIdle() : this.endIdle(), this.scale(), this.emit("resize");
  }
  onFocus(t2) {
  ...
  manageCaption(t2 = void 0) {
    ...
    if (this.caption && this.stop(this.caption), a2 && this.caption && (this.caption.remove(), this.caption = null), o2 && !this.caption)
      for (const t3 of (null === (e2 = this.carousel) || void 0 === e2 ? void 0 : e2.slides) || [])
        t3.captionEl && (t3.captionEl.remove(), t3.captionEl = void 0, E(t3.el, Kt), null === (i2 = t3.el) || void 0 === i2 || i2.removeAttribute("aria-labelledby"));
    ...
    if (a2) {
      if (c2 = t2.captionEl || null, r2 && !c2) {
        ...
        c2 = document.createElement("div"), S(c2, n2), c2.setAttribute("id", e3), t2.captionEl = r2.appendChild(c2), S(r2, Kt), r2.setAttribute("aria-labelledby", e3);
      }
    } else {
      if (c2 = this.caption, c2 || (c2 = s2.querySelector("." + n2)), !c2) {
        c2 = document.createElement("div"), c2.dataset.fancyboxCaption = "", S(c2, n2);
        (this.footer || s2).prepend(c2);
      }
      S(s2, Kt), this.caption = c2;
    }
    c2 && (c2.innerHTML = "", ne(l2) || "number" == typeof l2 ? c2.innerHTML = l2 + "" : l2 instanceof HTMLElement && c2.appendChild(l2));
  }
  checkFocus(t2) {
    this.focus(t2);
  }
  focus(t2) {
    ...
    let h2 = null;
    t2 ? (!n2 || l2.indexOf(n2) < 0) && (h2 = c2 || s2, l2.length && (i2 === ae ? h2 = l2[0] : this.lastFocus !== s2 && i2 !== oe || (h2 = l2[l2.length - 1]))) : h2 = o2 && "image" === o2.type ? s2 : c2 || s2, h2 && it(h2), this.lastFocus = document.activeElement, this.ignoreFocusChange = false;
  }
  next() {
  ...
  revealContent(t2, e2) {
    ...
    i2 && n2 && (this.emit("reveal", t2), this.hideLoading(t2), t2.state = ot.Opening, (e2 = this.isOpeningSlide(t2) ? void 0 === e2 ? this.optionFor(t2, "showClass") : e2 : "f-fadeIn") ? this.animate(n2, e2, () => {
      this.done(t2);
    }) : this.done(t2));
  }
  done(t2) {
    this.isClosing() || (t2.state = ot.Ready, this.emit("done", t2), S(t2.el, "is-done"), this.isCurrentSlide(t2) && this.option("autoFocus") && queueMicrotask(() => {
      var e2;
  ...
  showLoading(t2) {
    ...
    if (!e2)
      return;
    S(e2, Gt), this.emit("loading", t2), t2.spinnerEl || setTimeout(() => {
      if (!this.isClosing() && !t2.spinnerEl && t2.state === ot.Loading) {
        let i2 = n(w);
  ...
  hideLoading(t2) {
    ...
    this.isClosing() ? null == i2 || i2.remove() : (E(e2, Gt), i2 && this.animate(i2, "f-fadeOut", () => {
      i2.remove();
    }), t2.state === ot.Loading && (this.emit("loaded", t2), t2.state = ot.Ready));
  }
  setError(t2, e2) {
    if (this.isClosing())
      return;
  ...
  proceedClose(t2, e2) {
    ...
    if (r2 && (J(r2) ? it(r2) : r2.focus()), s2 && (S(s2, "is-closing"), s2.setAttribute("aria-hidden", "true"), this.option("animated") && S(s2, Zt), s2.style.pointerEvents = "none"), o2) {
      ...
      for (const t3 of o2.slides) {
        t3.state = ot.Closing, this.hideLoading(t3);
    ...
    this.emit("close", t2), this.state !== st.CustomClosing ? (void 0 === e2 && a2 && (e2 = this.optionFor(a2, "hideClass")), e2 && a2 ? (this.animate(a2.contentEl, e2, () => {
  ...
  destroy() {
    ...
    if (this.state === st.Destroy)
      return;
    this.state = st.Destroy, null === (t2 = this.carousel) || void 0 === t2 || t2.destroy();
    const e2 = this.container;
    e2 && e2.remove(), re.delete(this.id);
    const i2 = _ce.getInstance();
    i2 ? i2.focus() : (oe && (oe.remove(), oe = null), ae && (ae.remove(), ae = null), E(document.documentElement, Wt), (() => {
      if (!Q)
        return;
      const t3 = document, e3 = t3.body;
      e3.classList.remove(Xt), e3.style.setProperty(Yt, ""), t3.documentElement.style.setProperty(qt, "");
    })(), this.emit("destroy"));
  }
  static bind(t2, e2, i2) {
    if (!Q)
      return;
    let n2, s2 = "", o2 = {};
    if (void 0 === t2 ? n2 = document.body : ne(t2) ? (n2 = document.body, s2 = t2, "object" == typeof e2 && (o2 = e2 || {})) : (n2 = t2, ne(e2) && (s2 = e2), "object" == typeof i2 && (o2 = i2 || {})), !n2 || !x(n2))
      return;
    s2 = s2 || "[data-fancybox]";
  ...
  static unbind(t2, e2) {
    let i2, n2 = "";
    if (ne(t2) ? (i2 = document.body, n2 = t2) : (i2 = t2, ne(e2) && (n2 = e2)), !i2)
      return;
  ...
  static fromEvent(t2) {
    ...
    if ((!e2 || d2 || c2) && (r2 = [].slice.call(n2.querySelectorAll(s2))), e2 && !c2 && (r2 = d2 ? r2.filter((t3) => t3.getAttribute(`${h2}`) === d2) : [e2]), !r2.length)
      return;
    const f2 = _ce.getInstance();
    return f2 && f2.options.triggerEl && r2.indexOf(f2.options.triggerEl) > -1 ? void 0 : (e2 && (l2.startIndex = r2.indexOf(e2)), _ce.fromNodes(r2, l2));
  }
  static fromSelector(t2, e2, i2) {
    let n2 = null, s2 = "", o2 = {};
    if (ne(t2) ? (n2 = document.body, s2 = t2, "object" == typeof e2 && (o2 = e2 || {})) : t2 instanceof HTMLElement && ne(e2) && (n2 = t2, s2 = e2, "object" == typeof i2 && (o2 = i2 || {})), !n2 || !s2)
      return false;
  ...
  static fromNodes(t2, e2) {
    ...
    const i2 = [];
    for (const n2 of t2) {
      const t3 = n2.dataset || {}, s2 = t3[ie] || n2.getAttribute(ee) || n2.getAttribute("currentSrc") || n2.getAttribute(ie) || void 0;
      let o2;
      const a2 = e2.delegate;
      let r2;
      a2 && i2.length === e2.startIndex && (o2 = a2 instanceof HTMLImageElement ? a2 : a2.querySelector("img:not([aria-hidden])")), o2 || (o2 = n2 instanceof HTMLImageElement ? n2 : n2.querySelector("img:not([aria-hidden])")), o2 && (r2 = o2.currentSrc || o2[ie] || void 0, !r2 && o2.dataset && (r2 = o2.dataset.lazySrc || o2.dataset[ie] || void 0));
  ...
  static getInstance(t2) {
    if (t2)
      return re.get(t2);
    return Array.from(re.values()).reverse().find((t3) => !t3.isClosing() && t3) || null;
  }
  static getSlide() {
    var t2;
...
Object.defineProperty(ce, "version", { enumerable: true, configurable: true, writable: true, value: "5.0.28" }), Object.defineProperty(ce, "defaults", { enumerable: true, configurable: true, writable: true, value: nt }), Object.defineProperty(ce, "Plugins", { enumerable: true, configurable: true, writable: true, value: $t }), Object.defineProperty(ce, "openers", { enumerable: true, configurable: true, writable: true, value: /* @__PURE__ */ new Map() });
export {
  K as Carousel,
  ce as Fancybox,
  R as Panzoom
