            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        <tr v-for="(item, index) in banners.data" :key="item.id" class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <td class="px-4 py-3">
                                    <span v-if="item.isActive == 1" class="bg-green-100 text-green-800 flex w-20 justify-center items-center text-xs font-medium me-2 px-2 py-1 rounded dark:bg-green-900 dark:text-green-300">Active</span>
                                    <span v-else class="bg-red-100 text-red-800 flex w-20 justify-center items-center text-xs font-medium me-2 px-2 py-1 rounded dark:bg-red-900 dark:text-red-300">Non Active</span>
                                </td>
                            </td>
