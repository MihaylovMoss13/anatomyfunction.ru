        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex items-center lg:order-2">
                ...
                >
                    ...
                    >
                        <li>
                            <ResponsiveNavLink :href="route('logout')" method="post" as="button" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Выйти</ResponsiveNavLink>
                        </li>
                    </ul>
                </div>
            </div>
