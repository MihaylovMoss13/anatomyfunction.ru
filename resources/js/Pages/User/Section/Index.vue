...
import SectionList from "@/Pages/User/Section/SectionList.vue";
...
<template>
    <App>
        <Head title="Функциональная анатомия" />
               ...
               <Banner/>
                ...
                <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900">Section List</h1>
...
<!--                            </button>-->
                    ...
                    <section aria-labelledby="sections-heading" class="pb-24 pt-6">
                        <h2 id="sections-heading" class="sr-only">Анатомия</h2>
...
<!--                                end price filter-->
                            ...
                            <div class="lg:col-span-3">
                                <div class="relative"><SectionList :sections="sections" /></div>
                            </div>
                        </div>
                    </section>
                </main>
